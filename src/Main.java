...
public class Main {
    public static void main(String[] args) {
        ...
        cats.add(3,new Cat("Russian Blue", "Milo", "Grey", 1, 'M', 9.10, false,false));
        ...
        if (age < AdopterAgeRequirement) {
            ...
            if (adoptChoice == 'y' || adoptChoice == 'Y') {
                ...
                } else if (petChoice == 'C' || petChoice == 'c') {
                    System.out.println("\nAvailable Cats:");
                    for (Cat cat : cats) {
                        cat.displayInfo();
                    }
        ...
        System.out.print("Please enter the number of the dog you would like to adopt: ");
        int dogNumber = input.nextInt();
        if (dogNumber > 4){
            System.out.println("Dog number must be between 1 and 4.");
